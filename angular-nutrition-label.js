...
(function () {
  ...
  .directive('nutritionLabel', ["$log", "nutritionLabelGlobalOptions", function nutritionLabel($log, nutritionLabelGlobalOptions) {
    ...
    var map = [{
      labelAttribute: 'valueCalories',
      attrId: 208
    }, {
      labelAttribute: 'valueFatCalories',
      attrId: 204,
      adapter: function adapter(v) {
        return v * 9;
      }
    }, {
      ...
      labelAttribute: 'valueSatFat',
      attrId: 606
    }, {
      labelAttribute: 'valueTransFat',
      attrId: 605
    }, {
      labelAttribute: 'valueMonoFat',
      attrId: 645
    }, {
      labelAttribute: 'valuePolyFat',
      attrId: 646
    }, {
      labelAttribute: 'valueCholesterol',
      attrId: 601
    }, {
      labelAttribute: 'valueSodium',
      attrId: 307
    }, {
      labelAttribute: 'valuePotassium',
      attrId: 306
    }, {
      labelAttribute: 'valuePotassium_2018',
      attrId: 306,
      dailyValue: 4700
    }, {
      labelAttribute: 'valueTotalCarb',
      attrId: 205
    }, {
      labelAttribute: 'valueFibers',
      attrId: 291
    }, {
      labelAttribute: 'valueSugars',
      attrId: 269
    }, {
      labelAttribute: 'valueAddedSugars',
      attrId: 539
    }, {
      labelAttribute: 'valueProteins',
      attrId: 203
    }, {
      labelAttribute: 'valueVitaminA',
      attrId: 318,
      dailyValue: 5000
    }, {
      labelAttribute: 'valueVitaminC',
      attrId: 401,
      dailyValue: 60
    }, {
      labelAttribute: 'valueVitaminD',
      attrId: 328,
      dailyValue: 20
    }, {
      labelAttribute: 'valueCalcium',
      attrId: 301,
      dailyValue: 1300
    }, {
      ...
      map.forEach(function (definition) {
        ...
        if (!angular.isUndefined(value)) {
          ...
          if (definition.dailyValue) {
            ...
            var dailyValueProperty = 'daily' + definition.labelAttribute[0].toUpperCase() + definition.labelAttribute.substr(1);
